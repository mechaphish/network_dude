...
class Connection(object):
    ...
    def __init__(self, port, data_folder):
        ...
        print("[*] logging network traffic from port:" + str(port) + " to folder:" + str(self.data_folder))
    ...
    def parse(self, data):
        ...
        if len(data) < Connection.HEADER_LEN:
            print("[!] invalid message length: " + str(len(data)))
            return None
        ...
        if len(message) != msg_len:
            print("[!] invalid message.  actual: " + str(len(data)) + " expected: " + str(msg_len))
            return None
...
def do_setup():
    ...
    if os.path.exists(data_folder):
        print("[*] Cleaning up Data Folder:" + str(data_folder))
    ...
    # Complete Setup
    print("[*] Creating Data Folder:" + str(data_folder))
    os.makedirs(data_folder)
    print("[+] Setup Complete with Data Folder:" + str(data_folder) + " and timeout:" + str(round_idle_time) +
          " seconds")
            ...
            if idle_time >= idle_time_threshold:
                ...
                try:
                    ...
                    if target_file_name is not None:
                        print("[*] End of Round. Dumping the file:" + str(target_file_name) + " into DB.")
                except Exception as e:
                    try:
                        # To avoid deadlocks.
                        connection_object.curr_file_lock.release()
